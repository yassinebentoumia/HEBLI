  ...
  const startCamera = async () => {
    try {
      ...
      if (err.name === 'NotAllowedError') {
        ...
        msg += 'Camera access requires HTTPS or localhost. You are likely accessing via an IP address.';
      } else {
